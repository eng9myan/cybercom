...
from .views import (
    ...
    LicenseViewSet, SubscriptionViewSet, ProductEditionViewSet, FeatureFlagViewSet,
    TenantFeatureFlagOverrideViewSet, WhiteLabelConfigViewSet, ConcurrentLicenseSessionViewSet,
    CustomerPortalAccessViewSet, SupportTicketViewSet, MarketplaceListingViewSet,
    MarketplaceInstallationViewSet, CommercialMetricsSnapshotViewSet,
)
...
router.register("feature-flag-overrides", TenantFeatureFlagOverrideViewSet, basename="feature-flag-override")
router.register("white-label-configs", WhiteLabelConfigViewSet, basename="white-label-config")
router.register("concurrent-sessions", ConcurrentLicenseSessionViewSet, basename="concurrent-session")
...
router.register("marketplace-installations", MarketplaceInstallationViewSet, basename="marketplace-installation")

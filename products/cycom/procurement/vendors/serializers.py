...
from .models import VendorQualification, VendorPerformance
...
class VendorQualificationSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = [
            "id", "tenant_id", "vendor_id", "qualification_type",
            "expiry_date", "document_ref", "status",
...
class VendorPerformanceSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = [
            "id", "tenant_id", "vendor_id", "evaluation_period",

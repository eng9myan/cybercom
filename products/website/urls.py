...
from .views import (
    ...
    IndustryListView, IndustryDetailView,
    CaseStudyListView, CaseStudyDetailView,
    PartnerListView, PartnerApplicationCreateView,
    DocumentationSectionListView, DocumentationSectionDetailView, DocumentationSearchView,
    DemoRequestCreateView, DemoRequestStatusView,
    ContactCreateView, ContactStatusView,
...
urlpatterns = [
    ...
    path("documentation/<slug:slug>/", DocumentationSectionDetailView.as_view(), name="doc-section-detail"),

    # Demo Request
    path("demo-request/", DemoRequestCreateView.as_view(), name="demo-request-create"),
    path("demo-request/<str:reference_number>/status/", DemoRequestStatusView.as_view(), name="demo-request-status"),

...
class Admission(BaseModel):
    encounter = models.OneToOneField(Encounter, on_delete=models.CASCADE, related_name="hospital_admission")
...
class TransferApproval(BaseModel):
    transfer_request = models.OneToOneField(TransferRequest, on_delete=models.CASCADE, related_name="approval")
...
class DischargeSummary(BaseModel):
    admission = models.OneToOneField(Admission, on_delete=models.CASCADE, related_name="discharge_details")

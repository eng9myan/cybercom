...
class DiseaseRegistryTest(TestCase):
    ...
    def _registry(self, name="Diabetes Registry", registry_type="diabetes"):
        ...
        return DiseaseRegistry.objects.create(**_mk(
            name=name,
    ...
    def test_registry_icd11_codes_json(self):
        from products.cymed.population_health.registries.models import DiseaseRegistry
        reg = DiseaseRegistry.objects.create(**_mk(
    ...
    def test_registry_patient_enrollment(self):
        from products.cymed.population_health.registries.models import (
            DiseaseRegistry, RegistryPatient
        )
        reg = self._registry()
        rp = RegistryPatient.objects.create(**_mk(
            registry=reg,
            patient_id=PATIENT,
    ...
    def test_registry_patient_unique_per_registry(self):
        ...
        reg = self._registry()
        RegistryPatient.objects.create(**_mk(
            registry=reg, patient_id=PATIENT, enrollment_date="2024-01-01",
        ))
        with self.assertRaises(IntegrityError):
            RegistryPatient.objects.create(**_mk(
                registry=reg, patient_id=PATIENT, enrollment_date="2024-06-01",
            ))

    def test_registry_status_history(self):
        from products.cymed.population_health.registries.models import (
            DiseaseRegistry, RegistryPatient, RegistryStatus
        )
        reg = self._registry()
        rp = RegistryPatient.objects.create(**_mk(
            registry=reg, patient_id=PATIENT, enrollment_date="2024-01-01",
        ))
        rs = RegistryStatus.objects.create(**_mk(
            registry_patient=rp,
    ...
    def test_registry_outcome_recorded(self):
        from products.cymed.population_health.registries.models import (
            DiseaseRegistry, RegistryPatient, RegistryOutcome
        )
        reg = self._registry()
        rp = RegistryPatient.objects.create(**_mk(
            registry=reg, patient_id=PATIENT, enrollment_date="2024-01-01",
        ))
        out = RegistryOutcome.objects.create(**_mk(
            registry_patient=rp,
...
class PopulationGroupTest(TestCase):
    ...
    def test_population_group_creation(self):
        ...
        grp = PopulationGroup.objects.create(**_mk(
    ...
    def test_population_segment(self):
        from products.cymed.population_health.public_health.models import (
            PopulationGroup, PopulationSegment
        )
        grp = PopulationGroup.objects.create(**_mk(
        ...
        seg = PopulationSegment.objects.create(**_mk(
    ...
    def test_health_risk_ai_advisory_only(self):
        ...
        risk = HealthRisk.objects.create(**_mk(
            patient_id=PATIENT,
    ...
    def test_health_goal_lifecycle(self):
        ...
        goal = HealthGoal.objects.create(**_mk(
            patient_id=PATIENT,
    ...
    def test_national_provider_registration(self):
        ...
        np = NationalProvider.objects.create(**_mk(
    ...
    def test_national_facility_registration(self):
        ...
        fac = NationalFacility.objects.create(**_mk(
...
class SurveillanceTest(TestCase):
    ...
    def test_surveillance_case_creation(self):
        ...
        case = SurveillanceCase.objects.create(**_mk(
            patient_id=PATIENT,
            disease_code="1C62",
    ...
    def test_outbreak_creation(self):
        ...
        outbreak = Outbreak.objects.create(**_mk(
            disease_code="1C62",
            disease_name="COVID-19",
    ...
    def test_outbreak_alert_escalation(self):
        ...
        alert = OutbreakAlert.objects.create(**_mk(
            outbreak=outbreak,
            alert_level="red",
    ...
    def test_public_health_event(self):
        ...
        event = PublicHealthEvent.objects.create(**_mk(
    ...
    def test_case_investigation(self):
        from products.cymed.population_health.surveillance.models import (
            SurveillanceCase, CaseInvestigation
        )
        case = SurveillanceCase.objects.create(**_mk(
            patient_id=PATIENT,
            disease_code="1A90",
        ...
        inv = CaseInvestigation.objects.create(**_mk(
...
class TenantIsolationTest(TestCase):
    ...
    def test_surveillance_case_tenant_isolation(self):
        ...
        SurveillanceCase.objects.create(
            tenant_id=tenant_a, patient_id=PATIENT, disease_code="1C62",
            disease_name="COVID-19", case_type="confirmed", case_date="2025-01-01",
        )
        SurveillanceCase.objects.create(
            tenant_id=tenant_b, patient_id=PATIENT, disease_code="1C62",
            disease_name="COVID-19", case_type="suspected", case_date="2025-01-01",
        )

...
class CareGapTest(TestCase):
    ...
    def test_care_gap_rule_creation(self):
        ...
        rule = CareGapRule.objects.create(
            **_mk(
    ...
    def test_care_gap_recommendation_ai_generated(self):
        ...
        rec = CareGapRecommendation.objects.create(
            **_mk(
                care_gap=gap,
    ...
    def test_care_gap_resolution_by_human(self):
        from products.cymed.population_health.care_gaps.models import CareGap, CareGapResolution
        ...
        resolution = CareGapResolution.objects.create(
            **_mk(
                care_gap=gap,
...
class RiskManagementTest(TestCase):
    ...
    def test_risk_factor_linked_to_score(self):
        from products.cymed.population_health.risk_management.models import RiskFactor, RiskScore
    ...
    def test_risk_category_thresholds(self):
        ...
        cat = RiskCategory.objects.create(
            **_mk(
...
class CohortTest(TestCase):
    ...
    def test_cohort_outcome(self):
        ...
        out = CohortOutcome.objects.create(
            **_mk(
                cohort=cohort,
                patient_id=PATIENT,
...
class QualityTest(TestCase):
    def test_quality_measure_definition(self):
        ...
        measure = QualityMeasure.objects.create(
            **_mk(
    ...
    def test_clinical_audit(self):
        ...
        audit = ClinicalAudit.objects.create(
            **_mk(

...
class EpidemiologyTest(TestCase):
    def test_epidemiology_study_creation(self):
        ...
        study = EpidemiologyStudy.objects.create(
            **_mk(
    ...
    def test_disease_trend_time_series(self):
        ...
        trend = DiseaseTrend.objects.create(
            **_mk(
                disease_code="1C62",
    ...
    def test_population_indicator(self):
        ...
        ind = PopulationIndicator.objects.create(
            **_mk(
...
class NationalProgramsTest(TestCase):
    ...
    def test_program_enrollment(self):
        ...
        prog = self._program()
        enroll = ProgramEnrollment.objects.create(
            **_mk(
                program=prog,
                patient_id=PATIENT,
    ...
    def test_program_outcome_requires_provider(self):
        ...
        prog = self._program()
        out = ProgramOutcome.objects.create(
            **_mk(
                program=prog,
                patient_id=PATIENT,
...
class DigitalHealthTest(TestCase):
    def test_national_health_id_issuance(self):
        ...
        nhid = NationalHealthID.objects.create(
            **_mk(
                patient_id=PATIENT,
    ...
    def test_national_health_id_unique_per_patient(self):
        ...
        NationalHealthID.objects.create(
            **_mk(
                patient_id=PATIENT,
                national_id_number="1234567890",
                id_type="national_id",
    ...
    def test_health_pass_issuance(self):
        ...
        hpass = HealthPass.objects.create(
            **_mk(
                patient_id=PATIENT,
                pass_type="travel",
    ...
    def test_digital_wallet_entry(self):
        ...
        entry = DigitalHealthWalletEntry.objects.create(
            **_mk(
                patient_id=PATIENT,
...
class AnalyticsTest(TestCase):
    def test_national_health_snapshot(self):
        ...
        snap = NationalHealthSnapshot.objects.create(
            **_mk(
    ...
    def test_outbreak_forecast_advisory_only(self):
        ...
        forecast = OutbreakForecast.objects.create(
            **_mk(
                disease_code="1C62",
                disease_name="COVID-19",
    ...
    def test_population_analytics_insight_workflow(self):
        ...
        insight = PopulationAnalyticsInsight.objects.create(
            **_mk(
...
class ReportingTest(TestCase):
    def test_national_report_creation(self):
        ...
        report = NationalReport.objects.create(
            **_mk(
    ...
    def test_government_submission_human_required(self):
        ...
        submission = GovernmentSubmission.objects.create(
            **_mk(

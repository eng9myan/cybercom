    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("incidence_rate", models.DecimalField(blank=True, decimal_places=4, max_digits=10, null=True)),
                ("prevalence_rate", models.DecimalField(blank=True, decimal_places=4, max_digits=10, null=True)),
                ("mortality_rate", models.DecimalField(blank=True, decimal_places=4, max_digits=10, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("confidence_interval_low", models.DecimalField(blank=True, decimal_places=4, max_digits=14, null=True)),
                ("confidence_interval_high", models.DecimalField(blank=True, decimal_places=4, max_digits=14, null=True)),
            ],

...
from .views import LabOperationsDashboardViewSet, LabTurnaroundMetricViewSet, LabProductivityReportViewSet, LabQualityDashboardViewSet, LabMicrobiologyDashboardViewSet
...
router.register("microbiology-dashboard", LabMicrobiologyDashboardViewSet, basename="lab-micro-dashboard")

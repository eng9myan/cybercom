...
from .views import PathologyCaseViewSet, PathologySpecimenViewSet, GrossExaminationViewSet, MicroscopicExaminationViewSet, PathologyDiagnosisViewSet
...
router.register("microscopic-examinations", MicroscopicExaminationViewSet, basename="lab-micro-exams")

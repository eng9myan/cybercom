...
from .serializers import PathologyCaseSerializer, PathologySpecimenSerializer, GrossExaminationSerializer, MicroscopicExaminationSerializer, PathologyDiagnosisSerializer
...
class PathologyCaseViewSet(LaboratoryModelViewSet):
    ...
    def perform_create(self, serializer):
        ...
        serializer.save(tenant_id=tenant_id, case_number=f"PATH-{str(uuid.uuid4()).upper()[:10]}", patient_id=self.request.data.get("patient_id"))

...
class Migration(migrations.Migration):
    ...
    operations = [
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            ("sectioning", "Sectioning and Staining"),
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="lab_pathology.pathologycase",
                    ),
                ),
                (
                    "specimen",
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="diagnoses",
                        to="lab_pathology.pathologyspecimen",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="microscopic_examinations",
                        to="lab_pathology.pathologycase",
                    ),
                ),
                (
            ...
            fields=[
                ...
                (
                    ...
                    models.OneToOneField(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="gross_examination",
                        to="lab_pathology.pathologyspecimen",
                    ),
                ),
            ],
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["tenant_id", "status", "assigned_pathologist"],
                name="cymed_lab_p_tenant__fb30ef_idx",
            ),
        ),

...
from .views import BloodProductViewSet, BloodInventoryViewSet, BloodCompatibilityViewSet, TransfusionRequestViewSet
...
router.register("transfusion-requests", TransfusionRequestViewSet, basename="lab-transfusion-requests")

...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=["tenant_id", "assigned_to_provider_id", "status"], name="cymed_prov_task_prov_status_idx"),
        ),
        migrations.AddIndex(
            model_name="clinicaltask",
            index=models.Index(fields=["tenant_id", "patient_id", "status"], name="cymed_prov_task_patient_status_idx"),
        ),
        migrations.AddIndex(
            model_name="clinicaltask",
            index=models.Index(fields=["tenant_id", "priority", "status"], name="cymed_prov_task_priority_status_idx"),
        ),
        migrations.AddIndex(
            model_name="clinicaltask",
            index=models.Index(fields=["tenant_id", "due_at"], name="cymed_prov_task_tenant_due_idx"),
        ),
        migrations.AddIndex(
            model_name="taskassignment",
            index=models.Index(fields=["tenant_id", "task", "provider_id"], name="cymed_prov_taskassign_task_prov_idx"),
        ),
        migrations.AddIndex(
            model_name="taskcomment",
            index=models.Index(fields=["tenant_id", "task", "created_at"], name="cymed_prov_taskcomment_task_idx"),
        ),
        migrations.AddIndex(

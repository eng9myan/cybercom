...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["tenant_id", "status", "last_message_at"],
        ...
        migrations.AddIndex(
            model_name="clinicalmessagethread",
            index=models.Index(
                fields=["tenant_id", "patient_id"], name="cymed_prov_thread_patient_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="clinicalmessagethread",
            index=models.Index(
                fields=["tenant_id", "is_urgent", "status"], name="cymed_prov_thread_urgent_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="clinicalmessage",
            index=models.Index(
                fields=["tenant_id", "thread", "sent_at"], name="cymed_prov_msg_thread_sent_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="clinicalmessage",
            index=models.Index(
                fields=["tenant_id", "sender_provider_id", "sent_at"],
        ...
        migrations.AddIndex(
            model_name="clinicalmessage",
            index=models.Index(
                fields=["tenant_id", "is_read", "priority"], name="cymed_prov_msg_read_priority_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="messageattachment",
            index=models.Index(
                fields=["tenant_id", "message"], name="cymed_prov_msgattach_msg_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="clinicalgroup",
            index=models.Index(
                fields=["tenant_id", "group_type", "is_active"],
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["tenant_id", "thread", "provider_id"],
        ...
        migrations.AddIndex(
            model_name="messagethreadparticipant",
            index=models.Index(
                fields=["tenant_id", "provider_id", "is_active"],

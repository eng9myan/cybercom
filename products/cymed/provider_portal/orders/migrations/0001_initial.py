    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("order_set_type", models.CharField(
                    choices=[
                        ("admission", "Admission"),
                        ("discharge", "Discharge"),
                        ("procedure", "Procedure"),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=["tenant_id", "patient_id", "order_category"], name="cymed_prov_ord_tid_pid_cat_idx"),
        ),
        migrations.AddIndex(
            model_name="providerorderrequest",
            index=models.Index(fields=["tenant_id", "ordering_provider_id", "status"], name="cymed_prov_ord_tid_opid_sts_idx"),
        ),
    ]

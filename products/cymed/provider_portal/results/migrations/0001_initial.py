...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=["tenant_id", "patient_id", "result_type"], name="cymed_prov_res_tid_pid_type_idx"),
        ),
        migrations.AddIndex(
            model_name="providerresultview",
            index=models.Index(fields=["tenant_id", "ordering_provider_id", "is_reviewed"], name="cymed_prov_res_tid_opid_rev_idx"),
        ),

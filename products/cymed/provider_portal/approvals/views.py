...
class ApprovalRequestViewSet(viewsets.ModelViewSet):
    ...
    filterset_fields = [
        'approval_type', 'requested_by_provider_id', 'approver_id',
        'patient_id', 'priority', 'status', 'reference_type',
    ]
    search_fields = ['title', 'description', 'requested_by_name', 'approver_name', 'rejection_reason']
    ...
    def get_queryset(self):
        ...
        ).prefetch_related('decisions', 'audit_log')
...
class ApprovalWorkflowViewSet(viewsets.ModelViewSet):
    ...
    filter_backends = [DjangoFilterBackend, filters.SearchFilter, filters.OrderingFilter]
    filterset_fields = [
        'approval_type', 'is_sequential', 'requires_all_approvers',
        'is_active', 'created_by_provider_id', 'specialty',
    ]

...
class ProviderTelemedicineSessionViewSet(viewsets.ModelViewSet):
    ...
    filterset_fields = [
        'patient_id', 'provider_id', 'session_type', 'visit_type', 'status',
        'cymed_encounter_id', 'follow_up_required',
    ]
...
class ConsultRequestViewSet(viewsets.ModelViewSet):
    ...
    filter_backends = [DjangoFilterBackend, filters.SearchFilter, filters.OrderingFilter]
    filterset_fields = [
        'patient_id', 'requesting_provider_id', 'consulting_provider_id',
        'consulting_specialty', 'urgency', 'status', 'is_telemedicine',
    ]
    search_fields = ['consulting_specialty', 'consult_reason', 'requesting_provider_name', 'response_summary']
...
class SecondOpinionRequestViewSet(viewsets.ModelViewSet):
    ...
    filter_backends = [DjangoFilterBackend, filters.SearchFilter, filters.OrderingFilter]
    filterset_fields = [
        'patient_id', 'requesting_provider_id', 'requested_specialist_id',
        'requested_specialty', 'urgency', 'status',
    ]

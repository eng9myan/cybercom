...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["tenant_id", "provider_id"], name="cymed_prov_wkspc_tenant_prov_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="providerworkspace",
            index=models.Index(
                fields=["tenant_id", "is_active"], name="cymed_prov_wkspc_tenant_active_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="workspacesession",
            index=models.Index(
                fields=["tenant_id", "workspace", "is_active"],
        ...
        migrations.AddIndex(
            model_name="workspacesession",
            index=models.Index(
                fields=["tenant_id", "started_at"], name="cymed_prov_sess_tenant_started_idx"
            ),
        ),
    ]

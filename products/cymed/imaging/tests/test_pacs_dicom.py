...
def make_pacs_node(tenant_id, code=None):
    ...
    return PACSNode.objects.create(
        tenant_id=tenant_id,
        code=code or f"PACS-{uuid.uuid4().hex[:4]}",
        name="Primary PACS",
        ae_title="PACS01",
        host="192.168.10.50",
        port=11112,
...
class TestPACSGateway:
    ...
    def test_pacs_query(self):
        from products.cymed.imaging.pacs_gateway.models import PACSQuery
    ...
    def test_study_route(self):
        from products.cymed.imaging.pacs_gateway.models import StudyRoute
    ...
    def test_pacs_event(self):
        from products.cymed.imaging.pacs_gateway.models import PACSEvent
...
class TestDICOMRegistry:
    ...
    def test_dicom_series(self):
        from products.cymed.imaging.dicom_registry.models import DICOMSeries, DICOMStudy
    ...
    def test_dicom_instance(self):
        from products.cymed.imaging.dicom_registry.models import (
            DICOMInstance,
            DICOMSeries,
            DICOMStudy,
        )

...
from .views import (
    ImagingAppointmentViewSet,
    ImagingRoomViewSet,
    ModalityScheduleViewSet,
    RadiologistScheduleViewSet,
)
...
router.register(
    "radiologist-schedules", RadiologistScheduleViewSet, basename="radiologist-schedule"
)

...
class ImagingOrderService:
    ...
    @staticmethod
    def create_order(
        tenant_id, patient_id, order_type, procedures, priority, ordered_by,
        encounter_id=None, clinical_indication="", icd11_codes=None,
    ) -> dict:
        from products.cymed.imaging.orders.models import (
            ImagingOrder, ImagingOrderItem, ImagingProcedure, ImagingOrderStatusHistory,
        )
        ...
        for proc_code in procedures:
            try:
                procedure = ImagingProcedure.objects.get(tenant_id=tenant_id, code=proc_code, is_active=True)
        ...
        ImagingOrderStatusHistory.objects.create(
            ...
            from_status="", to_status="pending", changed_by=ordered_by,
        )
...
class SchedulingService:
    ...
    @staticmethod
    def schedule_appointment(tenant_id, order_item_id, modality_id, scheduled_start, scheduled_end, radiologist_id=None, technologist_id=None, room_id=None) -> dict:
...
class FHIRImagingService:
    ...
    def to_fhir_service_request(order) -> dict:
        status_map = {
            "pending": "draft", "scheduled": "active", "in_progress": "active",
            "completed": "completed", "cancelled": "revoked", "on_hold": "on-hold",
        }
        resource = {
    ...
    def to_fhir_diagnostic_report(result) -> dict:
        status_map = {"pending": "registered", "preliminary": "preliminary", "final": "final", "amended": "amended"}
        resource = {
    ...
    def to_fhir_imaging_study(study) -> dict:
        return {
            ...
            "modality": [{"system": "http://dicom.nema.org/resources/ontology/DCM", "code": study.modality.upper()}],
        }
...
class WorklistService:
    ...
    @staticmethod
    def add_to_worklist(tenant_id, worklist_id, order_item_id, priority_rank=999, scheduled_time=None) -> dict:

    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slice_thickness', models.DecimalField(blank=True, decimal_places=3, max_digits=8, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('window_center', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True)),
                ('window_width', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True)),
                ('wado_url', models.TextField(blank=True)),
                ('transfer_syntax_uid', models.CharField(blank=True, max_length=255)),
                ('series', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='instances', to='img_dicom.dicomseries')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_item', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='dicom_study', to='img_orders.imagingorderitem')),
                ('pacs_node', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='img_pacs.pacsnode')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='study',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='series', to='img_dicom.dicomstudy'),
        ),
        migrations.CreateModel(
            name='StudyArchive',
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True, db_index=True)),
                ('tenant_id', models.UUIDField(db_index=True, editable=False)),
                ('archive_tier', models.CharField(choices=[('hot', 'Hot'), ('warm', 'Warm'), ('cold', 'Cold')], default='hot', max_length=20)),
                ...
                ('study', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='archive', to='img_dicom.dicomstudy')),
            ],
            options={

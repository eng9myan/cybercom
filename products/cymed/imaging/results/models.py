...
class ImagingResult(BaseModel):
    ...
    order_item = models.OneToOneField("img_orders.ImagingOrderItem", on_delete=models.CASCADE, related_name="result")
    report = models.OneToOneField(
        "img_reporting.RadiologyReport", null=True, blank=True, on_delete=models.SET_NULL, related_name="result"
    )
    status = models.CharField(max_length=30, choices=[
        ("pending", "Pending"), ("preliminary", "Preliminary"),
...
class StructuredMeasurement(BaseModel):
    ...
    result = models.ForeignKey("img_results.ImagingResult", on_delete=models.CASCADE, related_name="measurements")
...
class ResultCommunication(BaseModel):
    ...
    result = models.ForeignKey("img_results.ImagingResult", on_delete=models.CASCADE, related_name="communications")
    ...
    communication_method = models.CharField(max_length=50, choices=[
        ("portal", "Patient Portal"), ("phone", "Phone"), ("fax", "Fax"),
        ("email", "Email"), ("ehr", "EHR Integration"),
    ], default="portal")

...
class TestMessaging:
    ...
    def test_message_attachment(self):
        from products.cymed.patient_portal.messaging.models import (
            MessageAttachment,
            MessageThread,
            PatientMessage,
        )
        ...
        thread = MessageThread.objects.create(
            ...
            account_id=ACCOUNT,
            patient_id=PATIENT,
            thread_type="prescription_inquiry",
...
class TestPortalTenantIsolation:
    ...
    def test_invoice_isolation(self):
        ...
        PatientInvoice.objects.create(
            ...
            account_id=ACCOUNT,
            patient_id=PATIENT,
            cycom_invoice_id="T1-INV",
            invoice_number="T1-001",
            provider_name="T1 Clinic",
            amount_total=100,
            amount_patient_due=100,
            currency="USD",
        )
        PatientInvoice.objects.create(
            tenant_id=OTHER_TENANT,
            account_id=uuid.uuid4(),
            patient_id=uuid.uuid4(),
            cycom_invoice_id="T2-INV",
            invoice_number="T2-001",
            provider_name="T2 Clinic",
            amount_total=200,
            amount_patient_due=200,
            currency="USD",
        )
...
class TestFHIRLinking:
    ...
    def test_prescription_fhir_id(self):
        ...
        PortalPrescriptionView.objects.create(
            tenant_id=TENANT,
            account_id=ACCOUNT,
            patient_id=PATIENT,

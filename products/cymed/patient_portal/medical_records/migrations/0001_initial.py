...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('download_format', models.CharField(
                    choices=[('pdf', 'PDF'), ('json', 'JSON'), ('fhir', 'FHIR'), ('csv', 'CSV')],
                    default='pdf',
                    max_length=10,
                )),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['account_id', 'record_type'], name='cymed_rec_access_acct_type_idx'),
        ),
        migrations.AddIndex(
            model_name='medicalrecordaccess',
            index=models.Index(fields=['patient_id', 'accessed_at'], name='cymed_rec_access_patient_date_idx'),
        ),
        migrations.AddIndex(
            model_name='sharedrecord',
            index=models.Index(fields=['account_id', 'is_revoked'], name='cymed_shared_rec_acct_revoked_idx'),
        ),
        migrations.AddIndex(
            model_name='recorddownloadhistory',
            index=models.Index(fields=['account_id', 'downloaded_at'], name='cymed_dl_hist_acct_date_idx'),
        ),
        migrations.AddIndex(
            model_name='patientdocument',
            index=models.Index(fields=['account_id', 'document_type'], name='cymed_patient_doc_acct_type_idx'),
        ),
    ]

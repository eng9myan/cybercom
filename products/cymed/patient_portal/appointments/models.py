...
class PortalAppointmentRequest(BaseModel):
    ...
    provider_type = models.CharField(
        max_length=20, choices=PROVIDER_TYPE_CHOICES, default='clinic'
    )
    ...
    preferred_time_slot = models.CharField(
        max_length=20, choices=TIME_SLOT_CHOICES, default='any'
    )
...
class AppointmentReminder(BaseModel):
    ...
    reminder_type = models.CharField(
        max_length=20, choices=REMINDER_TYPE_CHOICES, default='push'
    )

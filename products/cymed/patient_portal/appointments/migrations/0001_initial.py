...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["account_id", "status"], name="cymed_appt_req_acct_status_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="portalappointmentrequest",
            index=models.Index(
                fields=["patient_id", "status"], name="cymed_appt_req_patient_status_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="portalappointmentrequest",
            index=models.Index(
                fields=["provider_id", "preferred_date_1"], name="cymed_appt_req_provider_date_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="waitlistentry",
            index=models.Index(
                fields=["account_id", "status"], name="cymed_waitlist_acct_status_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="waitlistentry",
            index=models.Index(
                fields=["provider_id", "status"], name="cymed_waitlist_provider_status_idx"
            ),
        ),
    ]

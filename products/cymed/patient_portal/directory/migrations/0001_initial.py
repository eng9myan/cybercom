...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['tenant_id', 'city', 'is_published'], name='cymed_dir_hosp_tenant_city_pub_idx'),
        ),
        migrations.AddIndex(
            model_name='hospitallisting',
            index=models.Index(fields=['is_featured', 'is_published'], name='cymed_dir_hosp_featured_pub_idx'),
        ),
        migrations.CreateModel(
            name='ClinicListing',
            fields=[

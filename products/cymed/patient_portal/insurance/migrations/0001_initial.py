...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['account_id', 'is_active', 'is_primary'], name='cymed_portal_ins_card_acct_idx'),
        ),
        migrations.AddIndex(
            model_name='coverageverification',
            index=models.Index(fields=['account_id', 'status'], name='cymed_portal_cov_ver_acct_idx'),
        ),
        migrations.AddIndex(
            model_name='preauthorizationrequest',
            index=models.Index(fields=['account_id', 'status'], name='cymed_portal_preauth_acct_idx'),
        ),
        migrations.AddIndex(
            model_name='claimstatus',
            index=models.Index(fields=['account_id', 'status', 'service_date'], name='cymed_portal_claim_acct_idx'),
        ),
    ]

...
class TelemedicineSessionViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return TelemedicineSession.objects.filter(tenant_id=self.request.tenant_id).select_related()
...
class TelemedicineDocumentViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return TelemedicineDocument.objects.filter(tenant_id=self.request.tenant_id).select_related(
            "session"
        )
...
class TelemedicineChatViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return TelemedicineChat.objects.filter(tenant_id=self.request.tenant_id).select_related(
            "session"
        )
...
class TelemedicineRatingViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return TelemedicineRating.objects.filter(tenant_id=self.request.tenant_id).select_related(
            "session"
        )

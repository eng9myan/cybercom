...
class Consultation(BaseModel):
    encounter = models.ForeignKey(Encounter, on_delete=models.CASCADE, related_name="clinic_consultations")
...
class ConsultationPlan(BaseModel):
    consultation = models.OneToOneField(Consultation, on_delete=models.CASCADE, related_name="treatment_plan")
...
class ConsultationFollowUp(BaseModel):
    consultation = models.ForeignKey(Consultation, on_delete=models.CASCADE, related_name="follow_ups")

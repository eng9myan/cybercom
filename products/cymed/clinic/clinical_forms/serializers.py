...
class ClinicalFormFieldSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ["id", "label", "label_ar", "field_type", "options_json", "required", "display_order"]
...
class ClinicalFormSubmissionSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ["id", "form", "patient_id", "encounter_id", "submitted_by", "submitted_at", "values_json"]

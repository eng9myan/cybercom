...
class ClinicAppointment(BaseModel):
    appointment = models.OneToOneField(Appointment, on_delete=models.CASCADE, related_name="clinic_details")
    specialty_code = models.CharField(max_length=100)
    checkin_status = models.CharField(max_length=50, choices=[
        ("pending", "Pending"), ("checked_in", "Checked In"), ("missed", "Missed")
    ], default="pending")
...
class AppointmentReminder(BaseModel):
    clinic_appointment = models.ForeignKey(ClinicAppointment, on_delete=models.CASCADE, related_name="reminders")
...
class AppointmentWaitlist(BaseModel):
    ...
    status = models.CharField(max_length=30, choices=[
        ("active", "Active"), ("offered", "Offered"), ("booked", "Booked"), ("cancelled", "Cancelled")
    ], default="active")

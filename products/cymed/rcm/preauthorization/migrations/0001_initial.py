    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("authorization_type", models.CharField(max_length=30, choices=[("service", "Service"), ("procedure", "Procedure"), ("medication", "Medication"), ("imaging", "Imaging"), ("hospitalization", "Hospitalization"), ("home_health", "Home Health"), ("dme", "Durable Medical Equipment"), ("rehabilitation", "Rehabilitation")])),
                ...
                ("status", models.CharField(max_length=20, default="draft", choices=[("draft", "Draft"), ("submitted", "Submitted"), ("pending_info", "Pending Information"), ("approved", "Approved"), ("partially_approved", "Partially Approved"), ("denied", "Denied"), ("expired", "Expired"), ("cancelled", "Cancelled")])),
                ("priority", models.CharField(max_length=10, default="routine", choices=[("routine", "Routine"), ("urgent", "Urgent"), ("stat", "STAT")])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
                ("preauthorization", models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name="requests", to="cymed_rcm_preauthorization.preauthorization")),
                ...
                ("submission_method", models.CharField(max_length=20, default="electronic", choices=[("electronic", "Electronic"), ("fax", "Fax"), ("phone", "Phone"), ("portal", "Portal")])),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
                ("preauthorization", models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name="decisions", to="cymed_rcm_preauthorization.preauthorization")),
                ("decision", models.CharField(max_length=20, choices=[("approved", "Approved"), ("partially_approved", "Partially Approved"), ("denied", "Denied"), ("pending_info", "Pending Information"), ("referred_to_committee", "Referred to Committee")])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
                ("preauthorization", models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name="appeals", to="cymed_rcm_preauthorization.preauthorization")),
                ...
                ("status", models.CharField(max_length=20, choices=[("submitted", "Submitted"), ("under_review", "Under Review"), ("approved", "Approved"), ("denied", "Denied"), ("withdrawn", "Withdrawn")])),

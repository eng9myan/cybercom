"""
CyMed Pharmacy Edition — Base ViewSet
...
class PharmacyModelViewSet(viewsets.ModelViewSet):
    """
    Base ViewSet for all Pharmacy Edition endpoints.
    Enforces:
      - Authentication (CyIdentity tokens)
    ...
    def _check_feature(self, request, feature_code: str) -> None:
        ...
        if not FeatureFlagService.is_enabled(
            ...
            raise PermissionDenied(
                detail=f"Feature '{feature_code}' is not enabled for your pharmacy edition."
            )

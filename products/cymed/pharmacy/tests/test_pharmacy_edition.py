...
class TestPrescription:
    ...
    def test_medication_renewal(self):
        from products.cymed.pharmacy.prescriptions.models import MedicationRenewal, Prescription
    ...
    def test_medication_refill(self):
        from products.cymed.pharmacy.prescriptions.models import MedicationRefill, Prescription
    ...
    def test_tenant_isolation_prescription(self):
        ...
        Prescription.objects.create(
            tenant_id=TENANT,
            prescription_number="RX-ISO-001",
            patient_id=PATIENT,
            prescriber_id=PROVIDER,
        )
        Prescription.objects.create(
            tenant_id=OTHER_TENANT,
            prescription_number="RX-ISO-002",
            patient_id=PATIENT,
            prescriber_id=PROVIDER,
        )
...
class TestDispensing:
    def test_create_dispense_order(self):
        ...
        order = DispenseOrder.objects.create(
            tenant_id=TENANT,
            dispense_number="DSP-TEST-001",
            patient_id=PATIENT,
            dispense_type="retail",
            status=DispenseStatus.QUEUED,
        )
    ...
    def test_dispense_order_str(self):
        ...
        order = DispenseOrder.objects.create(
            tenant_id=TENANT,
            dispense_number="DSP-STR-001",
            patient_id=PATIENT,
        )
        assert "DSP-STR-001" in str(order)

    def test_dispense_item_creation(self):
        from products.cymed.pharmacy.dispensing.models import DispenseItem, DispenseOrder

        order = DispenseOrder.objects.create(
            tenant_id=TENANT,
            dispense_number="DSP-TEST-002",
            patient_id=PATIENT,
        )
    ...
    def test_dispense_verification(self):
        ...
        order = DispenseOrder.objects.create(
            tenant_id=TENANT,
            dispense_number="DSP-VER-001",
            patient_id=PATIENT,
        )
        verification = DispenseVerification.objects.create(
            tenant_id=TENANT,
            dispense_order=order,
            verification_type="second_check",
...
class TestClinicalPharmacy:
    ...
    def test_clinical_intervention(self):
        from products.cymed.pharmacy.clinical_pharmacy.models import (
...
class TestFormulary:
    ...
    def test_create_formulary(self):
        ...
        formulary = Formulary.objects.create(
            tenant_id=TENANT,
            name="Hospital Formulary 2026",
            formulary_type=FormularyType.HOSPITAL,
            is_active=True,
            is_default=True,
        )
    ...
    def test_formulary_restriction(self):
        from products.cymed.pharmacy.formulary.models import (
            Formulary,
            FormularyDrug,
        ...
        formulary = Formulary.objects.create(
            tenant_id=TENANT,
            name="Restriction Test Formulary",
            formulary_type="hospital",
        )
        drug = FormularyDrug.objects.create(
            tenant_id=TENANT,
    ...
    def test_preferred_medication(self):
        ...
        formulary = Formulary.objects.create(
            tenant_id=TENANT,
            name="Pref Formulary",
            formulary_type="retail",
        )
        pref = PreferredMedication.objects.create(
            tenant_id=TENANT,
            formulary=formulary,
            non_formulary_drug_code="RXN-BRAND",
            non_formulary_drug_name="Brand Drug",
            preferred_drug_code="RXN-GENERIC",
            preferred_drug_name="Generic Drug",
...
class TestAutomation:
    def test_create_automation_device(self):
        from products.cymed.pharmacy.automation.models import (
            AutomationDevice,
            DeviceStatus,
            DeviceType,
        )
        ...
        device = AutomationDevice.objects.create(
            tenant_id=TENANT,
            device_code="ADC-ICU-01",
            device_name="ICU ADC Unit 1",
...
class TestAnalytics:
    def test_dashboard_snapshot(self):
        ...
        snapshot = PharmacyDashboardSnapshot.objects.create(
            ...
            prescriptions_total=150,
            prescriptions_dispensed=140,
            drug_interactions_detected=5,
            clinical_interventions=3,
        )
...
class TestProcurementBridge:
    def test_create_procurement_request(self):
        ...
        req = ProcurementRequest.objects.create(
            tenant_id=TENANT,
            request_number="PRQ-001",
            request_type="emergency",
            drug_code="RXN-RARE",
            drug_name="Rare Drug 100mg",

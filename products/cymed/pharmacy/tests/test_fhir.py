...
class TestFHIRMedicationRequest:
    ...
    def test_prescription_fhir_id_stored(self):
        ...
        rx = Prescription.objects.create(
            tenant_id=TENANT, prescription_number="RX-FHIR-001",
    ...
    def test_medication_order_fhir_id(self):
        ...
        order = MedicationOrder.objects.create(
            tenant_id=TENANT, order_number="MO-FHIR-001",
            patient_id=PATIENT, admission_id=uuid.uuid4(),
            prescriber_id=PROVIDER, drug_code="RXN-001",
            drug_name="Heparin 5000IU", dose="5000", dose_unit="IU",
            route="subcutaneous", frequency="BID",
            fhir_medication_request_id=fhir_id,
        )
    ...
    def test_medication_history_fhir_statement(self):
        ...
        h = MedicationHistory.objects.create(
            ...
            drug_code="RXN-002", drug_name="Aspirin 81mg",
            source="prescription", fhir_medication_statement_id=fhir_id,
        )
...
class TestFHIRMedicationDispense:
    ...
    def test_dispense_order_fhir_id(self):
        ...
        order = DispenseOrder.objects.create(
            tenant_id=TENANT, dispense_number="DSP-FHIR-001",
            patient_id=PATIENT, fhir_medication_dispense_id=fhir_id,
        )
    ...
    def test_medication_change_fhir_statement(self):
        ...
        change = MedicationChange.objects.create(
            ...
            drug_code="RXN-001", drug_name="Test Drug",
            change_type="continued", reason="Continue as before.",
            changed_by=PHARMACIST, fhir_medication_statement_id=fhir_id,
        )
...
class TestFHIRReconciliationBundle:
    ...
    def test_reconciliation_fhir_bundle(self):
        from products.cymed.pharmacy.medication_reconciliation.models import MedicationReconciliation
        fhir_bundle = f"Bundle/{uuid.uuid4()}"
        rec = MedicationReconciliation.objects.create(
            tenant_id=TENANT, patient_id=PATIENT, encounter_id=uuid.uuid4(),
            initiated_by=PHARMACIST, fhir_bundle_id=fhir_bundle,
        )
...
class TestFHIRSearchByID:
    ...
    def test_prescription_search_by_fhir_id(self):
        ...
        Prescription.objects.create(
            tenant_id=TENANT, prescription_number="RX-FHIR-002",
            patient_id=PATIENT, prescriber_id=PROVIDER,
            fhir_medication_request_id=fhir_id,
        )
    ...
    def test_dispense_search_by_fhir_id(self):
        ...
        DispenseOrder.objects.create(
            tenant_id=TENANT, dispense_number="DSP-FHIR-002",
            patient_id=PATIENT, fhir_medication_dispense_id=fhir_id,
        )

...
from .views import (
    MedicationReviewViewSet, ClinicalInterventionViewSet,
    PharmacistRecommendationViewSet, MedicationTherapyManagementViewSet
)
...
router.register(r"recommendations", PharmacistRecommendationViewSet, basename="pharmacist-recommendation")

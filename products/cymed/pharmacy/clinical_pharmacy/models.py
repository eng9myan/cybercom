...
class MedicationReview(BaseModel):
    ...
    status = models.CharField(
        max_length=30, choices=ReviewStatus.choices, default=ReviewStatus.SCHEDULED
    )
...
class ClinicalIntervention(BaseModel):
    ...
    review = models.ForeignKey(
        MedicationReview, on_delete=models.CASCADE, related_name="interventions"
    )
    patient_id = models.UUIDField(db_index=True)
    ...
    cost_saving_estimate = models.DecimalField(

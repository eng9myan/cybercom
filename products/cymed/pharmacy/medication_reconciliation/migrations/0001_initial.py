    ...
    operations = [
        migrations.CreateModel(
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            ("discharge", "Discharge Reconciliation"),
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            ("pharmacist_review", "Under Pharmacist Review"),
                            ("completed", "Completed"),
                            ("cancelled", "Cancelled"),
                        ],
                        default="initiated",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["patient_id", "reconciliation_type"],
                        name="cymed_rx_me_patient_fa0a9a_idx",
                    ),
                    models.Index(
                        fields=["encounter_id", "status"], name="cymed_rx_me_encount_a8cc6a_idx"
                    ),
                    models.Index(
                        fields=["tenant_id", "reconciliation_type", "status"],
                        name="cymed_rx_me_tenant__e97ba8_idx",
                    ),
                ],
            },
        ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="cymed_pharmacy_reconciliation.medicationreconciliation",
                    ),
                ),
            ],
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["reconciliation", "status"], name="cymed_rx_me_reconci_355da7_idx"
                    )
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="medication_changes",
                        to="cymed_pharmacy_reconciliation.medicationreconciliation",
                    ),
                ),
            ],
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["reconciliation", "change_type"],
                        name="cymed_rx_me_reconci_51097f_idx",
                    )
                ],
            },
        ),

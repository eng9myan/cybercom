...
class PatientAcuityScoreTest(TestCase):
    ...
    def test_acuity_level_1_stable(self):
        ...
        score = PatientAcuityScore.objects.create(**_mk(
            patient_id=PATIENT,
            ward_id=WARD,
            ...
            news2_score=2,
            hppd_target=4.0,
            scored_at=datetime(2026, 7, 1, 8, 0, tzinfo=dt_timezone.utc),
        ))
...
class WardCoverageRequirementTest(TestCase):
    ...
    def test_icu_coverage_requirement(self):
        ...
        req = WardCoverageRequirement.objects.create(**_mk(
            facility_id=FACILITY,
            ward_type="icu",
            day_ratio_nurse=1,
    ...
    def test_coverage_requirement_unique_per_ward_type(self):
        ...
        WardCoverageRequirement.objects.create(**_mk(
            facility_id=FACILITY,
            ward_type="nicu",
            day_ratio_nurse=1,
...
class SkillMixValidationTest(TestCase):
    ...
    def test_skill_mix_pass(self):
        ...
        v = SkillMixValidation.objects.create(**_mk(
...
class OnCallRosterTest(TestCase):
    ...
    def _roster(self, status="draft"):
        ...
        return OnCallRoster.objects.create(**_mk(
            facility_id=FACILITY,
            department_id=DEPT,
    ...
    def test_oncall_assignment(self):
        ...
        roster = self._roster()
        assignment = OnCallAssignment.objects.create(**_mk(
    ...
    def test_roster_requires_primary_and_secondary(self):
        from products.cymed.workforce_management.oncall.models import OnCallAssignment
        roster = self._roster()
        OnCallAssignment.objects.create(**_mk(
            oncall_roster=roster,
            workforce_profile_id=EMP_1,
            call_mode="in_house",
            call_tier="primary",
...
class OnCallPageTest(TestCase):
    ...
    def _page(self, urgency="urgent"):
        from products.cymed.workforce_management.oncall.models import OnCallRoster, OnCallPage
        roster = OnCallRoster.objects.create(**_mk(
            facility_id=FACILITY,
            department_id=DEPT,
        ...
        return OnCallPage.objects.create(**_mk(
            oncall_roster=roster,
    ...
    def test_page_escalation(self):
        ...
        now = datetime.now(tz=dt_timezone.utc)
        escalation = OnCallEscalation.objects.create(**_mk(
            page=page,
            escalation_level=1,
...
class WorkforceComplianceConfigTest(TestCase):
    ...
    def test_saudi_arabia_config(self):
        ...
        config = WorkforceComplianceConfig.objects.create(**_mk(
            country_code="SAU",
            region_code="ALL",
            max_weekly_hours=48,
    ...
    def test_ramadan_rule(self):
        from products.cymed.workforce_management.compliance.models import (
            WorkforceComplianceConfig, RamadanComplianceRule,
        )
        config = WorkforceComplianceConfig.objects.create(**_mk(
            country_code="SAU",
            region_code="ALL",
        ...
        rule = RamadanComplianceRule.objects.create(**_mk(
    ...
    def test_usa_california_config(self):
        from products.cymed.workforce_management.compliance.models import (
            WorkforceComplianceConfig, WardRatioConfig,
        )
        config = WorkforceComplianceConfig.objects.create(**_mk(
            country_code="USA",
            region_code="CA",
        ...
        WardRatioConfig.objects.create(**_mk(
            compliance_config=config,
            ward_type="icu",
            day_ratio_nurse=1,
            day_ratio_patients=2,
    ...
    def test_compliance_config_unique_per_country_region(self):
        from products.cymed.workforce_management.compliance.models import WorkforceComplianceConfig
        from django.db import IntegrityError
        WorkforceComplianceConfig.objects.create(**_mk(
            country_code="JOR",
            region_code="ALL",
            max_weekly_hours=48,
...
class FloatPoolTest(TestCase):
    ...
    def test_float_member_creation(self):
        ...
        member = FloatPoolMember.objects.create(**_mk(
            workforce_profile_id=EMP_1,
            facility_id=FACILITY,
    ...
    def test_float_deployment(self):
        from products.cymed.workforce_management.float_pool.models import FloatPoolMember, FloatDeployment
        member = FloatPoolMember.objects.create(**_mk(
            workforce_profile_id=EMP_1,
            facility_id=FACILITY,
        ))
        deployment = FloatDeployment.objects.create(**_mk(
            float_member=member,
    ...
    def test_agency_staff_verification_flow(self):
        ...
        staff = AgencyStaffRegistration.objects.create(**_mk(
            facility_id=FACILITY,
    ...
    def test_shortage_alert_diversion(self):
        ...
        alert = StaffingShortageAlert.objects.create(**_mk(
            facility_id=FACILITY,
            department_id=DEPT,

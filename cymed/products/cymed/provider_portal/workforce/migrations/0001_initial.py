...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["tenant_id", "provider_id", "schedule_date"],
                name="cymed_prov_sched_tid_pid_date_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="providerschedule",
            index=models.Index(
                fields=["tenant_id", "unit_id", "schedule_date"],
                name="cymed_prov_sched_tid_uid_date_idx",
            ),
        ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["tenant_id", "provider_id", "expiry_date"],
                name="cymed_prov_cred_tid_pid_exp_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="credentialexpiry",
            index=models.Index(
                fields=["tenant_id", "alert_status"], name="cymed_prov_cred_tid_alert_idx"
            ),
        ),
    ]

"""
Data migration: encrypt existing consultation clinical free-text (plaintext
from before the fields became EncryptedText).
...
_TARGETS = {
    ...
    "ConsultationDiagnosis": ("display",),
    "ConsultationProcedure": ("display", "notes"),
    "ConsultationPlan": ("instructions",),
    "ConsultationFollowUp": ("reason",),
}
...
class Migration(migrations.Migration):
    dependencies = [
        ("cymed_clinic_consultations", "0002_alter_consultation_assessment_and_more"),
    ]
    operations = [

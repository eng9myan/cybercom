...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["wallet_account_id", "card_type", "is_active"],
                name="cymed_portal_dcard_wallet_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="healthpass",
            index=models.Index(
                fields=["account_id", "pass_type", "status"], name="cymed_portal_hpass_acct_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="vaccinationrecord",
            index=models.Index(
                fields=["account_id", "vaccine_code", "administered_date"],
                name="cymed_portal_vacc_acct_idx",
            ),
        ),
    ]

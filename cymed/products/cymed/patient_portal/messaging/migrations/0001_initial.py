...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["account_id", "status", "last_message_at"],
                name="cymed_portal_thread_acct_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="patientmessage",
            index=models.Index(
                fields=["thread", "is_read"], name="cymed_portal_msg_thread_read_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="securemessagerecipient",
            index=models.Index(
                fields=["thread", "recipient_id"], name="cymed_portal_recip_thread_idx"
            ),
        ),
    ]

...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["account_id", "consent_type", "consent_status"],
                name="cymed_consent_rec_acct_type_status_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="consentrequest",
            index=models.Index(
                fields=["account_id", "status"], name="cymed_consent_req_acct_status_idx"
            ),
        ),
    ]

...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["account_id", "status", "due_date"],
                name="cymed_portal_invoices_acct_status_due_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="paymenttransaction",
            index=models.Index(
                fields=["account_id", "status", "paid_at"],
                name="cymed_portal_txn_acct_status_paid_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="paymentmethod",
            index=models.Index(
                fields=["account_id", "is_active"], name="cymed_portal_pm_acct_active_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="installmentplan",
            index=models.Index(
                fields=["account_id", "status"], name="cymed_portal_inst_acct_status_idx"
            ),
        ),
    ]

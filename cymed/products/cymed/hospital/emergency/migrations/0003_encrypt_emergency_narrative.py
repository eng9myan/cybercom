"""
Data migration: encrypt existing emergency clinical free-text (plaintext from before
...
_TARGETS = {'EmergencyVisit': ('presenting_complaint',), 'EmergencyTriage': ('chief_complaint',), 'EmergencyDisposition': ('notes',), 'EmergencyObservation': ('notes',)}


def encrypt_narrative(apps, schema_editor):
    from platform.common.tenant_context import tenant_context

    from products.cymed.hospital.emergency import models as m
...
class Migration(migrations.Migration):
    dependencies = [
        ("cymed_hospital_emergency", "0002_alter_emergencydisposition_notes_and_more"),
    ]
    operations = [

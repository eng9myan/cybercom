            ...
            fields=[
                ...
                (
                    ...
                    models.OneToOneField(
                        ...
                        related_name="hospital_admission",
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="cymed_hospital_adt.admissionreason",
                    ),
                ),
                (
                    "admission_type",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT,
                        to="cymed_hospital_adt.admissiontype",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT,
                        to="cymed_hospital_adt.dischargedisposition",
                    ),
                ),
                (
                    "reason",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT,
                        to="cymed_hospital_adt.dischargereason",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "encounter",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="cymed_encounters.encounter"
                    ),
                ),
                (
                    "patient",
            ...
            fields=[
                ...
                (
                    ...
                    models.OneToOneField(
                        ...
                        to="cymed_hospital_adt.transferrequest",
                    ),
                ),
            ],
            options={

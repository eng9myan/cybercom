"""
Data migration: encrypt existing anesthesia clinical free-text (plaintext from before
...
_TARGETS = {'AnesthesiaAssessment': ('notes',), 'AnesthesiaPlan': ('plan_description',), 'AnesthesiaRecord': ('notes',), 'RecoveryAssessment': ('comments',)}
...
class Migration(migrations.Migration):
    dependencies = [
        ("cymed_hospital_anesthesia", "0003_alter_anesthesiaassessment_notes_and_more"),
    ]
    operations = [

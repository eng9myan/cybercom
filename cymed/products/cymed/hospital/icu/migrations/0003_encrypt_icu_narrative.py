"""
Data migration: encrypt existing icu clinical free-text (plaintext from before
...
class Migration(migrations.Migration):
    dependencies = [
        ("cymed_hospital_icu", "0002_alter_criticalevent_actions_taken_and_more"),
    ]
    operations = [

"""
Data migration: encrypt existing operating_room clinical free-text (plaintext from before
...
_TARGETS = {'ProcedureConsent': ('patient_signature_blob',)}


def encrypt_narrative(apps, schema_editor):
    from platform.common.tenant_context import tenant_context

    from products.cymed.hospital.operating_room import models as m
...
class Migration(migrations.Migration):
    dependencies = [("cymed_hospital_operating_room", "0002_alter_procedureconsent_patient_signature_blob")]

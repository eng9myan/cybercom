"""
Data migration: encrypt existing discharge clinical free-text (plaintext from before
...
_TARGETS = {'DischargeMedication': ('notes',), 'DischargeInstruction': ('dietary_instructions', 'activity_restrictions', 'warning_symptoms')}


def encrypt_narrative(apps, schema_editor):
    from platform.common.tenant_context import tenant_context

    from products.cymed.hospital.discharge import models as m
...
class Migration(migrations.Migration):
    dependencies = [("cymed_hospital_discharge", "0002_alter_dischargeinstruction_activity_restrictions_and_more")]

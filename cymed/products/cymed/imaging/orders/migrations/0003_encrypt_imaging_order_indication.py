"""
Data migration: encrypt existing img_orders PHI free-text (plaintext from before
...
class Migration(migrations.Migration):
    dependencies = [("img_orders", "0002_alter_imagingorder_clinical_indication")]

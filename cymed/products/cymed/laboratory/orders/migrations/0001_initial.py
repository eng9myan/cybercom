    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["patient_id", "status"], name="cymed_lab_o_patient_b97209_idx"
                    ),
                    models.Index(
                        fields=["tenant_id", "order_type", "priority"],
                        name="cymed_lab_o_tenant__ddbdff_idx",
                    ),
                ],
            },
        ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True, related_name="panels", to="lab_orders.labtest"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(fields=["order", "status"], name="cymed_lab_o_order_i_b51ac1_idx")
                ],
            },
        ),
    ]

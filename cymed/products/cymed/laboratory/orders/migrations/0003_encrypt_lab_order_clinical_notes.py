"""
Data migration: encrypt existing lab_orders clinical free-text (plaintext from
...
class Migration(migrations.Migration):
    dependencies = [("lab_orders", "0002_alter_laborder_clinical_notes")]

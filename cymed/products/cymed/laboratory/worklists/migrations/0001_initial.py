...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "direction",
                    models.CharField(
                        choices=[("inbound", "From Analyzer"), ("outbound", "To Analyzer")],
                        max_length=10,
                    ),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="lab_worklists.analyzermessage",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="technologist_assignments",
                        to="lab_worklists.labworklist",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="analyzer_interfaces",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["analyzer", "status", "received_at"], name="cymed_lab_a_analyze_8c26d4_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="labworklist",
            index=models.Index(
                fields=["tenant_id", "department", "worklist_date"],
                name="cymed_lab_w_tenant__8662ef_idx",
            ),
        ),

"""
Data migration: encrypt existing lab_results clinical free-text (plaintext from
...
_TARGETS = {'LabResult': ('comments',), 'ResultValue': ('value_text',), 'ResultInterpretation': ('interpretation_text',)}


def encrypt_narrative(apps, schema_editor):
    from platform.common.tenant_context import tenant_context

    from products.cymed.laboratory.results import models as m
...
class Migration(migrations.Migration):
    dependencies = [("lab_results", "0002_alter_labresult_comments_and_more")]

    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "stat_average_tat_hours",
                    models.DecimalField(blank=True, decimal_places=2, max_digits=8, null=True),
                ),
                (
                    "within_tat_target_pct",
                    models.DecimalField(blank=True, decimal_places=2, max_digits=5, null=True),
                ),
            ],
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["tenant_id", "snapshot_date"], name="cymed_lab_o_tenant__5b019f_idx"
                    )
                ],
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "unique_together": {
                    ("tenant_id", "technologist_id", "period_type", "period_start")
                },
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "critical_notification_compliance_pct",
                    models.DecimalField(blank=True, decimal_places=2, max_digits=5, null=True),
                ),
                (
                    "proficiency_score",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "actual_tat_mean_hours",
                    models.DecimalField(blank=True, decimal_places=2, max_digits=8, null=True),
                ),
                (
                    "actual_tat_median_hours",
                    models.DecimalField(blank=True, decimal_places=2, max_digits=8, null=True),
                ),
                (
                    "actual_tat_p95_hours",
                    models.DecimalField(blank=True, decimal_places=2, max_digits=8, null=True),
                ),
                (
                    "within_target_pct",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["tenant_id", "department", "period_start"],
                        name="cymed_lab_t_tenant__731d57_idx",
                    )
                ],
            },
        ),

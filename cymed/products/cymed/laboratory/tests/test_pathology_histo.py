...
class TestPathology:
    ...
    def test_gross_examination(self):
        from products.cymed.laboratory.pathology.models import (
            GrossExamination,
            PathologyCase,
            PathologySpecimen,
        )
...
class TestHistopathology:
    ...
    def test_histology_case(self):
        from products.cymed.laboratory.histopathology.models import (
            HistologyCase,
            HistologyCaseStatus,
        )

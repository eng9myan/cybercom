"""
Data migration: encrypt existing cymed_lab_patient_results clinical free-text (plaintext from
...
_TARGETS = {'ResultRelease': ('counselling_note',)}
...
class Migration(migrations.Migration):
    dependencies = [("cymed_lab_patient_results", "0002_alter_resultrelease_counselling_note")]

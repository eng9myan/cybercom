"""
Data migration: encrypt existing cymed_lab_patient_results PHI free-text (plaintext from before
...
_TARGETS = {'ResultAcknowledgement': ('question_asked',)}


def encrypt_narrative(apps, schema_editor):
    from platform.common.tenant_context import tenant_context

    from products.cymed.laboratory.patient_results import models as m
...
class Migration(migrations.Migration):
    dependencies = [("cymed_lab_patient_results", "0004_alter_resultacknowledgement_question_asked")]

    ...
    operations = [
        migrations.CreateModel(
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            ("verification_pending", "Pending Pharmacist Verification"),
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["patient_id", "status"], name="cymed_rx_di_patient_330c59_idx"
                    ),
                    models.Index(
                        fields=["tenant_id", "dispense_type", "status"],
                        name="cymed_rx_di_tenant__2e3a66_idx",
                    ),
                    models.Index(fields=["prescription_id"], name="cymed_rx_di_prescri_45669e_idx"),
                    models.Index(
                        fields=["medication_order_id"], name="cymed_rx_di_medicat_68f053_idx"
                    ),
                ],
            },
        ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        related_name="items",
                        to="cymed_pharmacy_dispensing.dispenseorder",
                    ),
                ),
            ],
            options={
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="cymed_pharmacy_dispensing.dispenseitem",
                    ),
                ),
                (
                    "dispense_order",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["dispense_order", "status"], name="cymed_rx_di_dispens_002901_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="dispenseaudit",
            index=models.Index(
                fields=["dispense_order", "action"], name="cymed_rx_di_dispens_05de26_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="dispenseaudit",
            index=models.Index(
                fields=["tenant_id", "performed_at"], name="cymed_rx_di_tenant__4e4f16_idx"
            ),
        ),
    ]

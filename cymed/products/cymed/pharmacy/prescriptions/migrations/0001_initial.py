    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["patient_id", "is_active"], name="cymed_rx_me_patient_c5e929_idx"
                    ),
                    models.Index(
                        fields=["patient_id", "drug_code"], name="cymed_rx_me_patient_63d170_idx"
                    ),
                    models.Index(
                        fields=["tenant_id", "start_date"], name="cymed_rx_me_tenant__b236e7_idx"
                    ),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["patient_id", "admission_id", "status"],
                        name="cymed_rx_me_patient_0df40b_idx",
                    ),
                    models.Index(
                        fields=["tenant_id", "order_type", "status"],
                        name="cymed_rx_me_tenant__4d6ae6_idx",
                    ),
                    models.Index(
                        fields=["ward_id", "status"], name="cymed_rx_me_ward_id_34aa17_idx"
                    ),
                ],
            },
        ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="cymed_pharmacy_prescriptions.medicationorder",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["patient_id", "status"], name="cymed_rx_pr_patient_c5ebf8_idx"
                    ),
                    models.Index(
                        fields=["tenant_id", "prescription_type", "status"],
                        name="cymed_rx_pr_tenant__d29863_idx",
                    ),
                    models.Index(
                        fields=["prescriber_id", "prescribed_at"],
                        name="cymed_rx_pr_prescri_685229_idx",
                    ),
                    models.Index(
                        fields=["is_controlled", "dea_schedule"],
                        name="cymed_rx_pr_is_cont_dfc010_idx",
                    ),
                ],
            },
        ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="cymed_pharmacy_prescriptions.prescription",
                    ),
                ),
            ],
            options={
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="cymed_rx_me_prescri_9ab065_idx",
                    )
                ],
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["prescription", "drug_code"], name="cymed_rx_pr_prescri_8bd133_idx"
                    )
                ],
            },
        ),

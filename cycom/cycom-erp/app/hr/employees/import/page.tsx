...
export default function EmployeeImport() {
  ...
  const downloadTemplate = () => {
    const csvContent = "employee_no,name,email,phone,department,role,grade,bank,iban,location\n" +
      "EMP-00101,Ahmad Mansour,ahmad@cycom.jo,+962791112233,Engineering,Software Engineer,Grade 4,Arab Bank,JO85ARAB00000001010102,Amman HQ\n" +
      "EMP-00102,Rania Shawabkeh,rania@cycom.jo,+962794445566,HR,HR Generalist,Grade 3,Housing Bank,JO85HOUS00000002020203,Amman HQ\n";

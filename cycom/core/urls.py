...
urlpatterns = [
    ...
    # ── HITL approvals (mounted at api/hitl/, matching the frontend's
    #    pre-existing app/api/cycom/hitl/ proxy — same bare-prefix pattern
    #    as e-signature above) ──
    path("api/hitl/", include("products.cycom.hitl.urls")),

...
same layout can serve purchase orders, quotations and receipts alike.

Ported from cyshop's apps/tenants/docprint.py (cyshop's PO-print predates
CyCom's own procurement print action — this is the harvest CyCom was missing
before cyshop can be archived).
"""

This is an Cycom module helps to integrate the biometric machines with Cycom server without using the local database or any intermediate software. It gives the real time update from the biometric device to Cycom server. This works with the help of Biometrics Web API (https://camsunit.com/application/biometric-web-api.html)

        ...
        onWillRender(() => {
            ...
            if (!d.hours_per_day) {
                if (!warnedMissingHoursPerDay.has(key)) {
                    ...
                    console.warn(
                        "[hr_enhancement TimeOff] request_unit is hour but `hours_per_day` is missing in RPC payload. " +
...
console.info(
    "[hr_enhancement TimeOff] assets loaded: TimeOffCard patched. If you do not see this in the browser console, the module assets are not on this deployment."
);

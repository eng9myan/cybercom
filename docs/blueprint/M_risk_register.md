...
| R05 | **CyMed runtime unverified** — ~68k LOC, 69 test files, never run this cycle. HealthFlavour timeline assumes it's real. | 4 | 4 | 16 | Phase 1: run the suite, triage real vs scaffold, re-scope HealthFlavour on findings. Don't commit Health dates until verified. | Health pod | Open |

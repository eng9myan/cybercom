    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="platform_api.apiapplication",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "version",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT, to="platform_api.apiversion"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["tenant_id", "timestamp"], name="platform_ap_tenant__0345e3_idx"
                    ),
                    models.Index(
                        fields=["catalog_id", "timestamp"], name="platform_ap_catalog_b6f947_idx"
                    ),
                ],
            },
        ),

...
from platform.cydata.models import DataAsset, DataQualityRule, MasterDataMap, CDCPipelineLog
...
class CDCPipelineClient:
    ...
    """
    @classmethod
    def trigger_cdc_sync(cls, tenant_id: str, table_name: str, records_count: int) -> CDCPipelineLog:

"""
CyDrive — Django Settings.
Reuses the shared platform/ and shared/ layers promoted in Phase 1, same
pattern as cymed/ and cymart/ — no reimplemented identity/tenant/audit/events.
"""
...
DATABASES = {
    "default": {
        ...
        "NAME": os.environ.get("DB_NAME", "cydrive_dev"),
...
SPECTACULAR_SETTINGS = {
    "TITLE": "CyDrive API",
    "DESCRIPTION": "CyberCom delivery-company management platform. OAuth2/OIDC secured.",
    "VERSION": os.environ.get("APP_VERSION", "0.1.0"),
    "SECURITY": [{"bearerAuth": []}],
    "SERVERS": [{"url": "/api/v1", "description": "CyDrive API v1"}],
}
